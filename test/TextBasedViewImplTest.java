  ...
  public void testCurrentView() throws FileNotFoundException, InterruptedException {
    ...
    try {
      ...
      assertEquals("Shapes:\n" +
                      "Name: disk1\n" +
                      "Type: rectangle\n" +
                      "Min Corner: (190.0, 180.0), Width: 20.0, Height: 30.0, Color: (0.0, 0.0, 0.0)\n" +
                      "Appears at t=1\n" +
                      "Disappears at t=302\n" +
                      "\n" +
                      "Name: disk2\n" +
                      "Type: rectangle\n" +
                      "Min Corner: (167.0, 210.0), Width: 65.0, Height: 30.0, Color: (0.0, 0.0, 0.0)\n" +
                      "Appears at t=1\n" +
                      "Disappears at t=302\n" +
                      "\n" +
                      "Name: disk3\n" +
                      "Type: rectangle\n" +
                      "Min Corner: (145.0, 240.0), Width: 110.0, Height: 30.0, Color: (0.0, 0.0, 0.0)\n" +
                      "Appears at t=1\n" +
                      "Disappears at t=302\n" +
                      "\n" +
                      ...
                      "Shape disk1 changes color from (0.0,0.2,0.4) to (0.0,1.0,0.0) from t=249 to t=257\n" +
                      ...
                      "Shape disk2 changes color from (0.0,1.0,0.2) to (0.0,1.0,0.0) from t=217 to t=225\n" +
                      ...
                      "Shape disk3 changes color from (0.0,0.2,0.7) to (0.0,1.0,0.0) from t=153 to t=161\n" +
