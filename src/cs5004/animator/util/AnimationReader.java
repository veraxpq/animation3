...
public class AnimationReader {
   ...
   * @param <Model>    The main model interface type describing animations
   * @return
   */
  public static <Model> Model parseFile(Readable readable, AnimationBuilder<Model> builder) {
  ...
  private static <Model> void readCanvas(Scanner s, AnimationBuilder<Model> builder) {
    int[] vals = new int[4];
  ...
  private static <Model> void readShape(Scanner s, AnimationBuilder<Model> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static <Model> void readMotion(Scanner s, AnimationBuilder<Model> builder) {
